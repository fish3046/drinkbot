...
this.$element.trigger("inserted.bs."+this.type);var pos=this.getPosition(),actualWidth=$tip[0].offsetWidth,actualHeight=$tip[0].offsetHeight;if(autoPlace){var orgPlacement=placement,viewportDim=this.getPosition(this.$viewport);placement="bottom"==placement&&pos.bottom+actualHeight>viewportDim.bottom?"top":"top"==placement&&pos.top-actualHeight<viewportDim.top?"bottom":"right"==placement&&pos.right+actualWidth>viewportDim.width?"left":"left"==placement&&pos.left-actualWidth<viewportDim.left?"right":placement,$tip.removeClass(orgPlacement).addClass(placement)}var calculatedOffset=this.getCalculatedOffset(placement,pos,actualWidth,actualHeight);this.applyPlacement(calculatedOffset,placement);var complete=function(){var prevHoverState=that.hoverState;that.$element.trigger("shown.bs."+that.type),that.hoverState=null,"out"==prevHoverState&&that.leave(that)};$.support.transition&&this.$tip.hasClass("fade")?$tip.one("bsTransitionEnd",complete).emulateTransitionEnd(Tooltip.TRANSITION_DURATION):complete()}},Tooltip.prototype.applyPlacement=function(offset,placement){var $tip=this.tip(),width=$tip[0].offsetWidth,height=$tip[0].offsetHeight,marginTop=parseInt($tip.css("margin-top"),10),marginLeft=parseInt($tip.css("margin-left"),10);isNaN(marginTop)&&(marginTop=0),isNaN(marginLeft)&&(marginLeft=0),offset.top+=marginTop,offset.left+=marginLeft,$.offset.setOffset($tip[0],$.extend({using:function(props){$tip.css({top:Math.round(props.top),left:Math.round(props.left)})}},offset),0),$tip.addClass("in");var actualWidth=$tip[0].offsetWidth,actualHeight=$tip[0].offsetHeight;"top"==placement&&actualHeight!=height&&(offset.top=offset.top+height-actualHeight);var delta=this.getViewportAdjustedDelta(placement,offset,actualWidth,actualHeight);delta.left?offset.left+=delta.left:offset.top+=delta.top;var isVertical=/top|bottom/.test(placement),arrowDelta=isVertical?2*delta.left-width+actualWidth:2*delta.top-height+actualHeight,arrowOffsetPosition=isVertical?"offsetWidth":"offsetHeight";$tip.offset(offset),this.replaceArrow(arrowDelta,$tip[0][arrowOffsetPosition],isVertical)},Tooltip.prototype.replaceArrow=function(delta,dimension,isVertical){this.arrow().css(isVertical?"left":"top",50*(1-delta/dimension)+"%").css(isVertical?"top":"left","")},Tooltip.prototype.setContent=function(){var $tip=this.tip(),title=this.getTitle();$tip.find(".tooltip-inner")[this.options.html?"html":"text"](title),$tip.removeClass("fade in top bottom left right")},Tooltip.prototype.hide=function(callback){function complete(){"in"!=that.hoverState&&$tip.detach(),that.$element.removeAttr("aria-describedby").trigger("hidden.bs."+that.type),callback&&callback()}var that=this,$tip=$(this.$tip),e=$.Event("hide.bs."+this.type);return this.$element.trigger(e),e.isDefaultPrevented()?void 0:($tip.removeClass("in"),$.support.transition&&$tip.hasClass("fade")?$tip.one("bsTransitionEnd",complete).emulateTransitionEnd(Tooltip.TRANSITION_DURATION):complete(),this.hoverState=null,this)},Tooltip.prototype.fixTitle=function(){var $e=this.$element;($e.attr("title")||"string"!=typeof $e.attr("data-original-title"))&&$e.attr("data-original-title",$e.attr("title")||"").attr("title","")},Tooltip.prototype.hasContent=function(){return this.getTitle()},Tooltip.prototype.getPosition=function($element){$element=$element||this.$element;var el=$element[0],isBody="BODY"==el.tagName,elRect=el.getBoundingClientRect();null==elRect.width&&(elRect=$.extend({},elRect,{width:elRect.right-elRect.left,height:elRect.bottom-elRect.top}));var elOffset=isBody?{top:0,left:0}:$element.offset(),scroll={scroll:isBody?document.documentElement.scrollTop||document.body.scrollTop:$element.scrollTop()},outerDims=isBody?{width:$(window).width(),height:$(window).height()}:null;return $.extend({},elRect,scroll,outerDims,elOffset)},Tooltip.prototype.getCalculatedOffset=function(placement,pos,actualWidth,actualHeight){return"bottom"==placement?{top:pos.top+pos.height,left:pos.left+pos.width/2-actualWidth/2}:"top"==placement?{top:pos.top-actualHeight,left:pos.left+pos.width/2-actualWidth/2}:"left"==placement?{top:pos.top+pos.height/2-actualHeight/2,left:pos.left-actualWidth}:{top:pos.top+pos.height/2-actualHeight/2,left:pos.left+pos.width}},Tooltip.prototype.getViewportAdjustedDelta=function(placement,pos,actualWidth,actualHeight){var delta={top:0,left:0};if(!this.$viewport)return delta;var viewportPadding=this.options.viewport&&this.options.viewport.padding||0,viewportDimensions=this.getPosition(this.$viewport);if(/right|left/.test(placement)){var topEdgeOffset=pos.top-viewportPadding-viewportDimensions.scroll,bottomEdgeOffset=pos.top+viewportPadding-viewportDimensions.scroll+actualHeight;topEdgeOffset<viewportDimensions.top?delta.top=viewportDimensions.top-topEdgeOffset:bottomEdgeOffset>viewportDimensions.top+viewportDimensions.height&&(delta.top=viewportDimensions.top+viewportDimensions.height-bottomEdgeOffset)}else{var leftEdgeOffset=pos.left-viewportPadding,rightEdgeOffset=pos.left+viewportPadding+actualWidth;leftEdgeOffset<viewportDimensions.left?delta.left=viewportDimensions.left-leftEdgeOffset:rightEdgeOffset>viewportDimensions.right&&(delta.left=viewportDimensions.left+viewportDimensions.width-rightEdgeOffset)}return delta},Tooltip.prototype.getTitle=function(){var title,$e=this.$element,o=this.options;return title=$e.attr("data-original-title")||("function"==typeof o.title?o.title.call($e[0]):o.title)},Tooltip.prototype.getUID=function(prefix){do prefix+=~~(1e6*Math.random());while(document.getElementById(prefix));return prefix},Tooltip.prototype.tip=function(){if(!this.$tip&&(this.$tip=$(this.options.template),1!=this.$tip.length))throw new Error(this.type+" `template` option must consist of exactly 1 top-level element!");return this.$tip},Tooltip.prototype.arrow=function(){return this.$arrow=this.$arrow||this.tip().find(".tooltip-arrow")},Tooltip.prototype.enable=function(){this.enabled=!0},Tooltip.prototype.disable=function(){this.enabled=!1},Tooltip.prototype.toggleEnabled=function(){this.enabled=!this.enabled},Tooltip.prototype.toggle=function(e){var self=this;e&&(self=$(e.currentTarget).data("bs."+this.type),self||(self=new this.constructor(e.currentTarget,this.getDelegateOptions()),$(e.currentTarget).data("bs."+this.type,self))),e?(self.inState.click=!self.inState.click,self.isInStateTrue()?self.enter(self):self.leave(self)):self.tip().hasClass("in")?self.leave(self):self.enter(self)},Tooltip.prototype.destroy=function(){var that=this;clearTimeout(this.timeout),this.hide(function(){that.$element.off("."+that.type).removeData("bs."+that.type),that.$tip&&that.$tip.detach(),that.$tip=null,that.$arrow=null,that.$viewport=null})};var old=$.fn.tooltip;$.fn.tooltip=Plugin,$.fn.tooltip.Constructor=Tooltip,$.fn.tooltip.noConflict=function(){return $.fn.tooltip=old,this}}(jQuery),+function($){"use strict";function Plugin(option){return this.each(function(){var $this=$(this),data=$this.data("bs.popover"),options="object"==typeof option&&option;(data||!/destroy|hide/.test(option))&&(data||$this.data("bs.popover",data=new Popover(this,options)),"string"==typeof option&&data[option]())})}var Popover=function(element,options){this.init("popover",element,options)};if(!$.fn.tooltip)throw new Error("Popover requires tooltip.js");Popover.VERSION="3.3.5",Popover.DEFAULTS=$.extend({},$.fn.tooltip.Constructor.DEFAULTS,{placement:"right",trigger:"click",content:"",template:'<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>'}),Popover.prototype=$.extend({},$.fn.tooltip.Constructor.prototype),Popover.prototype.constructor=Popover,Popover.prototype.getDefaults=function(){return Popover.DEFAULTS},Popover.prototype.setContent=function(){var $tip=this.tip(),title=this.getTitle(),content=this.getContent();$tip.find(".popover-title")[this.options.html?"html":"text"](title),$tip.find(".popover-content").children().detach().end()[this.options.html?"string"==typeof content?"html":"append":"text"](content),$tip.removeClass("fade top bottom left right in"),$tip.find(".popover-title").html()||$tip.find(".popover-title").hide()},Popover.prototype.hasContent=function(){return this.getTitle()||this.getContent()},Popover.prototype.getContent=function(){var $e=this.$element,o=this.options;return $e.attr("data-content")||("function"==typeof o.content?o.content.call($e[0]):o.content)},Popover.prototype.arrow=function(){return this.$arrow=this.$arrow||this.tip().find(".arrow")};var old=$.fn.popover;$.fn.popover=Plugin,$.fn.popover.Constructor=Popover,$.fn.popover.noConflict=function(){return $.fn.popover=old,this}}(jQuery),+function($){"use strict";function ScrollSpy(element,options){this.$body=$(document.body),this.$scrollElement=$($(element).is(document.body)?window:element),this.options=$.extend({},ScrollSpy.DEFAULTS,options),this.selector=(this.options.target||"")+" .nav li > a",this.offsets=[],this.targets=[],this.activeTarget=null,this.scrollHeight=0,this.$scrollElement.on("scroll.bs.scrollspy",$.proxy(this.process,this)),this.refresh(),this.process()}function Plugin(option){return this.each(function(){var $this=$(this),data=$this.data("bs.scrollspy"),options="object"==typeof option&&option;data||$this.data("bs.scrollspy",data=new ScrollSpy(this,options)),"string"==typeof option&&data[option]()})}ScrollSpy.VERSION="3.3.5",ScrollSpy.DEFAULTS={offset:10},ScrollSpy.prototype.getScrollHeight=function(){return this.$scrollElement[0].scrollHeight||Math.max(this.$body[0].scrollHeight,document.documentElement.scrollHeight)},ScrollSpy.prototype.refresh=function(){var that=this,offsetMethod="offset",offsetBase=0;this.offsets=[],this.targets=[],this.scrollHeight=this.getScrollHeight(),$.isWindow(this.$scrollElement[0])||(offsetMethod="position",offsetBase=this.$scrollElement.scrollTop()),this.$body.find(this.selector).map(function(){var $el=$(this),href=$el.data("target")||$el.attr("href"),$href=/^#./.test(href)&&$(href);return $href&&$href.length&&$href.is(":visible")&&[[$href[offsetMethod]().top+offsetBase,href]]||null}).sort(function(a,b){return a[0]-b[0]}).each(function(){that.offsets.push(this[0]),that.targets.push(this[1])})},ScrollSpy.prototype.process=function(){var i,scrollTop=this.$scrollElement.scrollTop()+this.options.offset,scrollHeight=this.getScrollHeight(),maxScroll=this.options.offset+scrollHeight-this.$scrollElement.height(),offsets=this.offsets,targets=this.targets,activeTarget=this.activeTarget;if(this.scrollHeight!=scrollHeight&&this.refresh(),scrollTop>=maxScroll)return activeTarget!=(i=targets[targets.length-1])&&this.activate(i);if(activeTarget&&scrollTop<offsets[0])return this.activeTarget=null,this.clear();for(i=offsets.length;i--;)activeTarget!=targets[i]&&scrollTop>=offsets[i]&&(void 0===offsets[i+1]||scrollTop<offsets[i+1])&&this.activate(targets[i])},ScrollSpy.prototype.activate=function(target){this.activeTarget=target,this.clear();var selector=this.selector+'[data-target="'+target+'"],'+this.selector+'[href="'+target+'"]',active=$(selector).parents("li").addClass("active");active.parent(".dropdown-menu").length&&(active=active.closest("li.dropdown").addClass("active")),active.trigger("activate.bs.scrollspy")},ScrollSpy.prototype.clear=function(){$(this.selector).parentsUntil(this.options.target,".active").removeClass("active")};var old=$.fn.scrollspy;$.fn.scrollspy=Plugin,$.fn.scrollspy.Constructor=ScrollSpy,$.fn.scrollspy.noConflict=function(){return $.fn.scrollspy=old,this},$(window).on("load.bs.scrollspy.data-api",function(){$('[data-spy="scroll"]').each(function(){var $spy=$(this);Plugin.call($spy,$spy.data())})})}(jQuery),+function($){"use strict";function Plugin(option){return this.each(function(){var $this=$(this),data=$this.data("bs.tab");data||$this.data("bs.tab",data=new Tab(this)),"string"==typeof option&&data[option]()})}var Tab=function(element){this.element=$(element)};Tab.VERSION="3.3.5",Tab.TRANSITION_DURATION=150,Tab.prototype.show=function(){var $this=this.element,$ul=$this.closest("ul:not(.dropdown-menu)"),selector=$this.data("target");if(selector||(selector=$this.attr("href"),selector=selector&&selector.replace(/.*(?=#[^\s]*$)/,"")),!$this.parent("li").hasClass("active")){var $previous=$ul.find(".active:last a"),hideEvent=$.Event("hide.bs.tab",{relatedTarget:$this[0]}),showEvent=$.Event("show.bs.tab",{relatedTarget:$previous[0]});if($previous.trigger(hideEvent),$this.trigger(showEvent),!showEvent.isDefaultPrevented()&&!hideEvent.isDefaultPrevented()){var $target=$(selector);this.activate($this.closest("li"),$ul),this.activate($target,$target.parent(),function(){$previous.trigger({type:"hidden.bs.tab",relatedTarget:$this[0]}),$this.trigger({type:"shown.bs.tab",relatedTarget:$previous[0]})})}}},Tab.prototype.activate=function(element,container,callback){function next(){$active.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!1),element.addClass("active").find('[data-toggle="tab"]').attr("aria-expanded",!0),transition?(element[0].offsetWidth,element.addClass("in")):element.removeClass("fade"),element.parent(".dropdown-menu").length&&element.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!0),callback&&callback()}var $active=container.find("> .active"),transition=callback&&$.support.transition&&($active.length&&$active.hasClass("fade")||!!container.find("> .fade").length);$active.length&&transition?$active.one("bsTransitionEnd",next).emulateTransitionEnd(Tab.TRANSITION_DURATION):next(),$active.removeClass("in")};var old=$.fn.tab;$.fn.tab=Plugin,$.fn.tab.Constructor=Tab,$.fn.tab.noConflict=function(){return $.fn.tab=old,this};var clickHandler=function(e){e.preventDefault(),Plugin.call($(this),"show")};$(document).on("click.bs.tab.data-api",'[data-toggle="tab"]',clickHandler).on("click.bs.tab.data-api",'[data-toggle="pill"]',clickHandler)}(jQuery),+function($){"use strict";function Plugin(option){return this.each(function(){var $this=$(this),data=$this.data("bs.affix"),options="object"==typeof option&&option;data||$this.data("bs.affix",data=new Affix(this,options)),"string"==typeof option&&data[option]()})}var Affix=function(element,options){this.options=$.extend({},Affix.DEFAULTS,options),this.$target=$(this.options.target).on("scroll.bs.affix.data-api",$.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",$.proxy(this.checkPositionWithEventLoop,this)),this.$element=$(element),this.affixed=null,this.unpin=null,this.pinnedOffset=null,this.checkPosition()};Affix.VERSION="3.3.5",Affix.RESET="affix affix-top affix-bottom",Affix.DEFAULTS={offset:0,target:window},Affix.prototype.getState=function(scrollHeight,height,offsetTop,offsetBottom){var scrollTop=this.$target.scrollTop(),position=this.$element.offset(),targetHeight=this.$target.height();if(null!=offsetTop&&"top"==this.affixed)return offsetTop>scrollTop?"top":!1;if("bottom"==this.affixed)return null!=offsetTop?scrollTop+this.unpin<=position.top?!1:"bottom":scrollHeight-offsetBottom>=scrollTop+targetHeight?!1:"bottom";var initializing=null==this.affixed,colliderTop=initializing?scrollTop:position.top,colliderHeight=initializing?targetHeight:height;return null!=offsetTop&&offsetTop>=scrollTop?"top":null!=offsetBottom&&colliderTop+colliderHeight>=scrollHeight-offsetBottom?"bottom":!1},Affix.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(Affix.RESET).addClass("affix");var scrollTop=this.$target.scrollTop(),position=this.$element.offset();return this.pinnedOffset=position.top-scrollTop},Affix.prototype.checkPositionWithEventLoop=function(){setTimeout($.proxy(this.checkPosition,this),1)},Affix.prototype.checkPosition=function(){if(this.$element.is(":visible")){var height=this.$element.height(),offset=this.options.offset,offsetTop=offset.top,offsetBottom=offset.bottom,scrollHeight=Math.max($(document).height(),$(document.body).height());"object"!=typeof offset&&(offsetBottom=offsetTop=offset),"function"==typeof offsetTop&&(offsetTop=offset.top(this.$element)),"function"==typeof offsetBottom&&(offsetBottom=offset.bottom(this.$element));var affix=this.getState(scrollHeight,height,offsetTop,offsetBottom);if(this.affixed!=affix){null!=this.unpin&&this.$element.css("top","");var affixType="affix"+(affix?"-"+affix:""),e=$.Event(affixType+".bs.affix");if(this.$element.trigger(e),e.isDefaultPrevented())return;this.affixed=affix,this.unpin="bottom"==affix?this.getPinnedOffset():null,this.$element.removeClass(Affix.RESET).addClass(affixType).trigger(affixType.replace("affix","affixed")+".bs.affix")}"bottom"==affix&&this.$element.offset({top:scrollHeight-height-offsetBottom})}};var old=$.fn.affix;$.fn.affix=Plugin,$.fn.affix.Constructor=Affix,$.fn.affix.noConflict=function(){return $.fn.affix=old,this},$(window).on("load",function(){$('[data-spy="affix"]').each(function(){var $spy=$(this),data=$spy.data();data.offset=data.offset||{},null!=data.offsetBottom&&(data.offset.bottom=data.offsetBottom),null!=data.offsetTop&&(data.offset.top=data.offsetTop),Plugin.call($spy,data)})})}(jQuery),function(){function drinkConfig($locationProvider,$routeProvider){$locationProvider.html5Mode(!1),$routeProvider.when("/manage/drinks",{templateUrl:"/app/views/manage/drinks.html",controller:"drinks.manage.DrinksController",controllerAs:"ctrl"}).when("/manage/drinks/form",{templateUrl:"/app/views/manage/drinksform.html",controller:"drinks.manage.DrinksFormController",controllerAs:"ctrl"}).when("/manage/drinks/form/:id",{templateUrl:"/app/views/manage/drinksform.html",controller:"drinks.manage.DrinksFormController",controllerAs:"ctrl"}).when("/manage/ingredients",{templateUrl:"/app/views/manage/ingredients.html",controller:"drinks.manage.IngredientsController",controllerAs:"ctrl"}).when("/manage/ingredients/form",{templateUrl:"/app/views/manage/ingredientsform.html",controller:"drinks.manage.IngredientsFormController",controllerAs:"ctrl"}).when("/manage/ingredients/form/:id",{templateUrl:"/app/views/manage/ingredientsform.html",controller:"drinks.manage.IngredientsFormController",controllerAs:"ctrl"}).when("/manage/pumps",{templateUrl:"/app/views/manage/pumps.html",controller:"drinks.manage.PumpsController",controllerAs:"ctrl"}).otherwise({templateUrl:"/app/views/index.html",controller:"IndexController",controllerAs:"ctrl"})}angular.module("drinks",["ngResource","ngRoute","ui.bootstrap"]).config(["$locationProvider","$routeProvider",drinkConfig])}(),function(){"use strict";function DesktopController(LocationService){this.go=function(url){LocationService.go(url)}}angular.module("drinks").controller("drinks.controller.DesktopController",["drinks.service.LocationService",DesktopController])}(),function(){function DrinkResource($resource){return $resource("/db/drink/:id",{id:"@id"},{update:{method:"PUT",params:{id:"@id"}}})}angular.module("drinks").factory("drinks.resource.DrinkResource",["$resource",DrinkResource])}(),function(){function DrinkService($q,$http){this.make=function(drink){var deferred=$q.defer();return $http.post("/robot/make",drink).then(function(resp){deferred.resolve(resp.data)},function(resp){deferred.reject(resp)}),deferred.promise},this.getPossibleDrinks=function(){var deferred=$q.defer();return $http.get("/service/possible_drinks").then(function(resp){deferred.resolve(resp.data)},function(resp){deferred.reject(resp)}),deferred.promise}}angular.module("drinks").service("DrinkService",["$q","$http",DrinkService])}(),function(){function IndexController($modal,DrinkService,Pump,Ingredient){function init(){loadPossibleDrinks()}function loadPossibleDrinks(){DrinkService.getPossibleDrinks().then(function(resp){self.drinks=resp})}this.drinks=[],this.pumps=Pump.query(),this.ingredients=Ingredient.query();var self=this;this.drink={id:"",size:1},this.changePumpIngredient=function(pump){pump.$update({id:pump._id},function(){loadPossibleDrinks()})},this.make=function(){return""==this.drink.id?void alert("Select a drink to make"):void DrinkService.make(this.drink).then(function(resp){var drinkDuration=resp.duration;$modal.open({templateUrl:"make-modal.html",windowClass:"make-modal",controller:"drinks.controller.MakeModalController",controllerAs:"modalctrl",resolve:{duration:function(){return drinkDuration}}})},function(resp){alert("Failed! "+resp)})},init()}angular.module("drinks").controller("IndexController",["$modal","DrinkService","drinks.resource.PumpResource","Ingredient",IndexController])}(),function(){function Ingredient($resource){return $resource("/db/ingredient/:id",{id:"@id"},{update:{method:"PUT",params:{id:"@id"}}})}angular.module("drinks").factory("Ingredient",["$resource",Ingredient])}(),function(){function LocationService($location){this.go=function(url){$location.path(url)}}angular.module("drinks").service("drinks.service.LocationService",["$location",LocationService])}(),function(){"use strict";function MakeModalController($modalInstance,$interval,duration){var durationPadding=1e3,modalShowTime=duration+durationPadding,startTime=Date.now();this.progressMax=duration,this.progressCurrent=0;var self=this,interval=$interval(function(){var elapsed=Date.now()-startTime;self.progressCurrent=elapsed,elapsed>=modalShowTime&&($interval.cancel(interval),$modalInstance.close())},200)}angular.module("drinks").controller("drinks.controller.MakeModalController",["$modalInstance","$interval","duration",MakeModalController])}(),function(){"use strict";function NavbarController(LocationService){this.go=function(url){LocationService.go(url)}}angular.module("drinks").controller("drinks.controller.NavbarController",["drinks.service.LocationService",NavbarController])}(),function(){function Pump($resource){return $resource("/db/pump/:id",{id:"@id"},{update:{method:"PUT",params:{id:"@id"}}})}angular.module("drinks").factory("drinks.resource.PumpResource",["$resource",Pump])}(),function(){function DrinksController(LocationService,Drink){this.drinks=Drink.query();var self=this;this.addRecord=function(){LocationService.go("/manage/drinks/form")},this.deleteDrink=function(drink){confirm("Are you sure?")&&drink.$delete({id:drink._id},function(){for(var i in self.drinks)if(self.drinks[i]==drink){self.drinks.splice(i,1);break}})},this.edit=function(drink){LocationService.go("/manage/drinks/form/"+drink._id)}}angular.module("drinks").controller("drinks.manage.DrinksController",["drinks.service.LocationService","drinks.resource.DrinkResource",DrinksController])}(),function(){function DrinksFormController($routeParams,Drink,Ingredient,LocationService){function init(){$routeParams.id&&(self.drink=Drink.get({id:$routeParams.id}))}function navBack(){LocationService.go("/manage/drinks")}this.drink=new Drink,this.ingredients=Ingredient.query();var self=this;this.title=function(){return angular.isString(this.drink._id)?"Edit "+this.drink.name:"Add New Drink"},this.addIngredient=function(){this.drink.ingredients||(this.drink.ingredients=[]),this.drink.ingredients.push({})},this.removeIngredient=function(ing){for(var i in this.drink.ingredients)if(this.drink.ingredients[i]==ing){this.drink.ingredients.splice(i,1);break}},this.save=function(){angular.isString(this.drink._id)?this.drink.$update({id:this.drink._id},navBack):this.drink.$save(navBack)},init()}angular.module("drinks").controller("drinks.manage.DrinksFormController",["$routeParams","drinks.resource.DrinkResource","Ingredient","drinks.service.LocationService",DrinksFormController])}(),function(){function IngredientsController(LocationService,Ingredient){this.ingredients=Ingredient.query();var self=this;this.deleteRecord=function(record){confirm("Are you sure?")&&record.$delete({id:record._id},function(){for(var i in self.ingredients)if(self.ingredients[i]==record){self.ingredients.splice(i,1);break}})},this.addRecord=function(){LocationService.go("/manage/ingredients/form")},this.edit=function(record){LocationService.go("/manage/ingredients/form/"+record._id)}}angular.module("drinks").controller("drinks.manage.IngredientsController",["drinks.service.LocationService","Ingredient",IngredientsController])}(),function(){function IngredientsFormController($routeParams,Ingredient,LocationService){function init(){$routeParams.id&&(self.ingredient=Ingredient.get({id:$routeParams.id}))}function navBack(){LocationService.go("/manage/ingredients")}this.ingredient=new Ingredient;var self=this;this.title=function(){return angular.isString(this.ingredient._id)?"Edit "+this.ingredient.name:"Add New Ingredient"},this.save=function(){angular.isString(this.ingredient._id)?this.ingredient.$update({id:this.ingredient._id},navBack):this.ingredient.$save(navBack)},init()}angular.module("drinks").controller("drinks.manage.IngredientsFormController",["$routeParams","Ingredient","drinks.service.LocationService",IngredientsFormController])}(),function(){function PumpsController(Ingredient,Pump){this.ingredients=Ingredient.query(),this.pumps=Pump.query(),this.pins=[{id:2,label:"GPIO_02"},{id:3,label:"GPIO_03"},{id:4,label:"GPIO_04"},{id:5,label:"GPIO_05"},{id:6,label:"GPIO_06"},{id:7,label:"GPIO_07"},{id:8,label:"GPIO_08"},{id:9,label:"GPIO_09"},{id:10,label:"GPIO_10"},{id:11,label:"GPIO_11"},{id:12,label:"GPIO_12"},{id:13,label:"GPIO_13"},{id:14,label:"GPIO_14"},{id:15,label:"GPIO_15"},{id:16,label:"GPIO_16"},{id:17,label:"GPIO_17"},{id:18,label:"GPIO_18"},{id:19,label:"GPIO_19"},{id:20,label:"GPIO_20"},{id:21,label:"GPIO_21"},{id:22,label:"GPIO_22"},{id:23,label:"GPIO_23"},{id:24,label:"GPIO_24"},{id:25,label:"GPIO_25"},{id:26,label:"GPIO_26"},{id:27,label:"GPIO_27"}],this.deleteRecord=function(record){confirm("Are you sure?")&&record.$delete({id:record._id},function(){for(var i in self.pumps)if(self.pumps[i]==record){self.pumps.splice(i,1);break}})},this.addPump=function(){this.pumps||(this.pumps=[]),this.pumps.push(new Pump)},this.save=function(){for(var i in this.pumps)this.pumps[i].$update({id:this.pumps[i]._id})}}angular.module("drinks").controller("drinks.manage.PumpsController",["Ingredient","drinks.resource.PumpResource",PumpsController])}();
//# sourceMappingURL=drinks.min.js.map